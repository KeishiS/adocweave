...
const dualLicenseNotice = "either of the Apache License, Version\n2.0, or the MIT License";
if (license === undefined || !Buffer.from(license).toString("utf8").includes(dualLicenseNotice)) {
  throw new Error("The VSIX does not contain the dual-license LICENSE file");
}
