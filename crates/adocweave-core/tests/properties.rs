use adocweave_core::output::formatter::{FormatConfig, format_analysis};
...
use adocweave_core::resolution::{AuthoredUrlPolicy, UrlDecision};
...
use adocweave_core::text::{PositionEncoding, SourceDocument, SyntaxKind, TextSize};
...
) -> (String, Vec<String>, Vec<ReferenceKey>) {
    (
