...
use adocweave_core::semantic::{Block, UnsupportedKind};
use adocweave_core::text::SyntaxIssueClass;
use adocweave_core::{AnalysisOptions, Engine, ParseError, SyntaxMode};
...
fn diagnostic_codes(analysis: &adocweave_core::Analysis) -> Vec<String> {
    analysis
        .diagnostics()
        .iter()
