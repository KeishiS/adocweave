...
use adocweave_core::output::html::HtmlDocumentMode;
        ...
        output: serde_json::to_string_pretty(&serde_json::json!({
            ...
            "analysis": {
                "syntaxMode": match analysis.syntax.syntax_mode {
                    adocweave_core::SyntaxMode::Permissive => "permissive",
                    adocweave_core::SyntaxMode::Strict => "strict",
                },
            ...
            "format": {
                "newline": match format.newline {
                    adocweave_core::output::formatter::NewlineStyle::Lf => "lf",
                    adocweave_core::output::formatter::NewlineStyle::CrLf => "cr-lf",
                },
