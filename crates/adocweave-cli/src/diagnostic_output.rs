...
use adocweave::output::diagnostics::LINT_RULES;
#[cfg(test)]
use adocweave::output::diagnostics::{Diagnostic, sort_diagnostics};
...
#[cfg(test)]
mod tests {
    use adocweave::output::diagnostics::{DiagnosticCode, DiagnosticId, Severity, lint_rule};
