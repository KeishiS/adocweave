...
export const PRODUCT_TAG = /^adocweave-(lib|cli|lsp|wasm|textlint|vscode|zed)\/v(\d+\.\d+\.\d+)$/;
...
function verifyRepository() {
  ...
  if (JSON.stringify(products) !== JSON.stringify(["lib", "cli", "lsp", "wasm", "textlint", "vscode", "zed"])) {
